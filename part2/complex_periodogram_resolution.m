...
axis([0 1 -30 5]);
title('Peridogram with n=30, K=128','FontSize',title_font_size);
...
set(gca,'fontsize',axis_font_size);
axis([0 1 -30 5]);
title('Peridogram with n=50, K=128','FontSize',title_font_size);
xlabel('Frequency (Hz)', 'FontSize', x_axis_font_size);
ylabel('Power/Frequency (dB/Hz)', 'FontSize', y_axis_font_size);
run('../utility_functions/scale_graph.m');
...
set(gca,'fontsize',axis_font_size);
axis([0 1 -30 5]);
title('Peridogram with n=70, K=128','FontSize',title_font_size);
xlabel('Frequency (Hz)', 'FontSize', x_axis_font_size);
ylabel('Power/Frequency (dB/Hz)', 'FontSize', y_axis_font_size);
run('../utility_functions/scale_graph.m');
