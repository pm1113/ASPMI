...
title('Trial 2, Order 8','FontSize',title_font_size);
...
% graph_saving('../report/images/part2/ar_spectrum_eeg_trial_2_order_8');
...
axis([0 2 -100 0]);
set(gca,'fontsize',axis_font_size);
title('Trial 2, Order 12','FontSize',title_font_size);
xlabel('Frequency (Hz)', 'FontSize', x_axis_font_size);
ylabel('Power/Frequency (dB/Hz)', 'FontSize', y_axis_font_size);
run('../utility_functions/scale_graph.m');
% graph_saving('../report/images/part2/ar_spectrum_eeg_trial_2_order_12');
...
axis([0 2 -100 0]);
set(gca,'fontsize',axis_font_size);
title('Trial 2, Order 20','FontSize',title_font_size);
xlabel('Frequency (Hz)', 'FontSize', x_axis_font_size);
ylabel('Power/Frequency (dB/Hz)', 'FontSize', y_axis_font_size);
run('../utility_functions/scale_graph.m');
% graph_saving('../report/images/part2/ar_spectrum_eeg_trial_2_order_20');