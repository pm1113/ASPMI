...
title('Trial 1, Order 2','FontSize',title_font_size);
...
% graph_saving('../report/images/part2/ar_spectrum_eeg_trial_1_order_2');
...
axis([0 2 -100 0]);
set(gca,'fontsize',axis_font_size);
title('Trial 1, Order 4','FontSize',title_font_size);
xlabel('Frequency (Hz)', 'FontSize', x_axis_font_size);
ylabel('Power/Frequency (dB/Hz)', 'FontSize', y_axis_font_size);
run('../utility_functions/scale_graph.m');
% graph_saving('../report/images/part2/ar_spectrum_eeg_trial_1_order_4');
...
axis([0 2 -100 0]);
set(gca,'fontsize',axis_font_size);
title('Trial 1, Order 10','FontSize',title_font_size);
xlabel('Frequency (Hz)', 'FontSize', x_axis_font_size);
ylabel('Power/Frequency (dB/Hz)', 'FontSize', y_axis_font_size);
run('../utility_functions/scale_graph.m');
% graph_saving('../report/images/part2/ar_spectrum_eeg_trial_1_order_10');