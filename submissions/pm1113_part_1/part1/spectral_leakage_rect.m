...
%% Amplitude Threshold rect Window, Part 1
...
grid on;
grid minor;
% graph_saving('../report/images/part1/periodogram_leakage_bartlett_part_1');
...
grid on;
grid minor;
% graph_saving('../report/images/part1/periodogram_leakage_bartlett_part_2');
