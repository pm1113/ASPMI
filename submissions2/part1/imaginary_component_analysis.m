...
% graph_saving('../report/images/part1/dft_spectra_acf_x_real');
...
ylabel('Magnitude', 'FontSize', y_axis_font_size);
run('../utility_functions/scale_graph.m')
% graph_saving('../report/images/part1/dft_spectra_acf_x_imag');
...
ylabel('Magnitude', 'FontSize', y_axis_font_size);
run('../utility_functions/scale_graph.m')
% graph_saving('../report/images/part1/dft_spectra_acf_z_real');
...
ylabel('Magnitude', 'FontSize', y_axis_font_size);
run('../utility_functions/scale_graph.m')
% graph_saving('../report/images/part1/dft_spectra_acf_z_imag');
...
ylabel('Magnitude', 'FontSize', y_axis_font_size);
run('../utility_functions/scale_graph.m')
% graph_saving('../report/images/part1/acf_z_psd_without_imag');
...
ylabel('Magnitude', 'FontSize', y_axis_font_size);
run('../utility_functions/scale_graph.m')
graph_saving('../report/images/part1/acf_z_psd_with_imag');
