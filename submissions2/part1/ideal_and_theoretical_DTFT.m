...
% graph_saving('../report/images/part1/ideal_magnitude_spectrum_20hz_sine_wave');
...
axis([-50, 50 -0.2 1]);
run('../utility_functions/scale_graph.m');
% graph_saving('../report/images/part1/theoretical_magnitude_spectrum_windowed_20hz_sine_wave');